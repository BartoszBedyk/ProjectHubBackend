...
public class LogOutUserForm implements ActivityForm{
    ...
    public List<ActivityParam> getParams() {
        ...
        params.add(new ActivityParam(Fields.USER_ID.name(), userId, ActivityType.USER_LOG_OUT));
        params.add(new ActivityParam(Fields.FIRST_NAME.name(), firstName, ActivityType.USER_LOG_OUT));
        params.add(new ActivityParam(Fields.LAST_NAME.name(), lastName, ActivityType.USER_LOG_OUT));
        return params;
    }
}
